...
const plans = [
  ...
  },
  {
    ...
    annualPrice: 639,
    description:
      'Advanced AI capabilities, unlimited scale, and priority support for established immigration teams.',
    features: [
      'Unlimited active cases',
      'Unlimited caseworker accounts',
      'Everything in Standard',
      'AI Chat, Email & Contract drafting',
...
const comparisonFeatures = [
  ...
  { label: 'AI Chat (candidate-facing)', standard: false, pro: true },
  { label: 'AI Email drafting', standard: false, pro: true },
  { label: 'AI Contract generation', standard: false, pro: true },
  { label: 'AI Templates library', standard: false, pro: true },
